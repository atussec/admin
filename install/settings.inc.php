<?php
    ...
    define("EI_PASSWORD_ENCRYPTION_KEY", "apphp_adminpanel");
    ...
    // -------------------------------------------------------------------------
    // *** application name
    define("EI_APPLICATION_NAME", "ApPHP AdminPanel Free");
    define("EI_APPLICATION_VERSION", "1.0.5");
    
    // *** default start file name - application start file
    define("EI_APPLICATION_START_FILE", "../index.php");
    
    // *** license agreement page
    define("EI_LICENSE_AGREEMENT_PAGE", "license/GNU Lisence.txt");
   
    // *** text after successful installation
    define("EI_POST_TEXT", "To run this script properly you must set write permissions to <b>'pages/'</b> and <b>tmp/</b> directories.");
